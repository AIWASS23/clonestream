...
class OnBoardingPageViewController: UIViewController {
    ...
    var model: CloneStreamIntroModel
    ...
    init(model: CloneStreamIntroModel) {
        self.model = model
...
//        PreviewUIViewController(viewController: OnBoardingPageViewController(model: CloneStreamIntroModel(id: 0, imageUrl: "https://wallpapers.com/images/file/sage-naruto-cell-phone-art-gbjepana241apniy-gbjepana241apniy.jpg", title: "Welcome to CloneStream", subTitle: "The best movie streaming app of the century to make your days great!")))
